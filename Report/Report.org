...
No programa, aproximamos esse tempo por \SI{100}{\micro\second}, e considerámos $p_4$ desprezável.
...
conhecidas, pois em vez de ser /Retained Mode/, é, como o nome indica, /Immediate Mode GUI/.

Este paradigma foi popularizado por [[https://caseymuratori.com/about][Casey Muratori]], criador da série educativa [[https://handmadehero.org/][Handmade Hero]].
...
Para além destas features, tem ainda maneira de exportar animações quer copiando um array em C para o
